...
-- AddForeignKey
ALTER TABLE `ChetModel` ADD CONSTRAINT `ChetModel_senderId_fkey` FOREIGN KEY (`senderId`) REFERENCES `User`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `ChetModel` ADD CONSTRAINT `ChetModel_receiverId_fkey` FOREIGN KEY (`receiverId`) REFERENCES `User`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
